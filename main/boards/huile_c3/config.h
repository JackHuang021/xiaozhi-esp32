...
#define WS2812B_LED_GPIO        GPIO_NUM_2
#define TOUCH_BUTTON_GPIO       GPIO_NUM_9
#define SWITCH_GPIO             GPIO_NUM_20

#define MOTOR_PWM_GPIO          GPIO_NUM_0
#define MAG_PWM_GPIO            GPIO_NUM_1

#define UART1_TXD_GPIO          GPIO_NUM_13
#define UART1_RXD_GPIO          GPIO_NUM_12
